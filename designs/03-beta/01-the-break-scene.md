...
The playable sequence between pre-break and post-break. The player leaves the pong world and walks through the main character's hometown.
...
- What's in the hometown? What buildings, what details, what can the player interact with?
- How does the player find the phone number? Is it something they interact with or something they walk past?
- How does the player indicate they're done exploring?
- How long should the scene be spatially? One screen, multiple screens, a scrolling town?
- What does the friend look like and what are they doing in the scene?
